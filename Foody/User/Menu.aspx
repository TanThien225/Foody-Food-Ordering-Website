        ...
        <div class="container">
            ...
            <ul class="filters_menu">
                ...
                <asp:Repeater ID="rCategories" runat="server">
                    <ItemTemplate>
                        <%-- Binding from Product_Crud that Name as Name --%>
                        <%-- Part REgex using for situation that data filter have 2 and more word have space between that can not work
                            so that we using this way to stick to 1 word. Ex: Veg Pizza ---> VegPizza--%>
                ...
                <div class="row grid">
                    <asp:Repeater ID="rProducts" runat="server" OnItemCommand="rProducts_ItemCommand">
                        <ItemTemplate>
                            ...
                            <%-- Binding from Category_Crud that C.Name as CategoryName --%>
                                ...
                                <div class="box">
                                    <div>
                                        ...
                                        <div class="detail-box">
                                            ...
                                            <div class="options">
                                                <h6><%# Eval("Price") %></h6>
                                                <asp:LinkButton ID="lbAddToCart" runat="server"
                                                    ...
                                                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 456.029 456.029" xml:space="preserve">
                                                        <g enable-background="new 0 0 456.029 456.029">
                                                            <g>
