...
namespace Foody.User
{
    public partial class Registration : System.Web.UI.Page
    {
        ...
        {
            // IF there is no request posted to the server
            if (!IsPostBack)
            {
                //Check
                //&& Session["userId"] != null
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            if (isValidToExecute)
            {
                ...
                catch (SqlException ex)
                {
                    ...
                    {
                        lblMsg.Visible = true;
                        lblMsg.Text = "<b> " + txtUsername.Text.Trim() + " </b> username already exists. Let try new one!";
                        lblMsg.CssClass = "alert alert-danger";
                    }
                }
                catch (Exception ex)
        ...
        void getUserDetails()
        {
            ...
            //Debug.WriteLine("UserId " + Request.QueryString["id"]);
