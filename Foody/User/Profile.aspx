<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="Foody.User.Profile" %>
                            ...
                            <div class="card-title mb-4">
                                <div class="d-flex justify-content-start">
                                    <div class="image-container">
                                        <img src="<%= Utils.GetImageUrl(imageUrl) %>" id="imgProfile" style="width: 150px; height: 150px; object-fit: cover" class="img-thumbnail" />
                                    ...
                                    <div class="userData ml-3">
                                        ...
                                        <h6 class="d-block">
                                            <a href="javascript:void(0);">
                                                <asp:Label ID="lbUsername" runat="server" ToolTip="Unique Username">
                                    ...
                                    <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active text-info" id="basicInfo-tab" data-toggle="tab" href="#basicInfo" role="tab"
                                                ...
                                                <i class="fa fa-clock-o mr-2"></i>Basic Info
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="lblPrice" runat="server" 
                                                                            Text='<%# string.IsNullOrEmpty(Eval("Price").ToString()) ? "" : "$" + Eval("Price").ToString() %>'>
                                                                        </asp:Label>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("Status") %>'
                                                                            CssClass='<%# Eval("Status").ToString() == "Delivered" ? "badge badge-success" : 
                                                                                      Eval("Status").ToString() == "Dispatched"? "badge badge-info" : 
                                                                                                       "badge badge-warning" %>'>
                                                                        </asp:Label>
                                                                    </td>
                                                                </tr>
