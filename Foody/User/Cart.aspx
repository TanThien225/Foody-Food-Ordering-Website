<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="Foody.User.Cart" %>
                    ...
                    <tr>
                                ...
                                <div class="quantity">
                                    <div class="pro-qty">
                                        ...
                                        <asp:RegularExpressionValidator ID="revQuantity" runat="server" ErrorMessage="*"
                                            ForeColor="Red" Font-Size="Small" Display="Dynamic" SetFocusOnError="true" EnableClientScript="true"
                        ...
                        <td>
                            <asp:LinkButton ID="lbDelete" runat="server" Text="Remove" 
                                CommandArgument='<%# Eval("ProductId") %>' CommandName="remove"
