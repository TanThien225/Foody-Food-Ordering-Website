<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="Foody.Admin.Report" %>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvFromDate" runat="server" ErrorMessage="*"
                                                    ControlToValidate="txtFromDate" ForeColor="Red" Display="Dynamic" SetFocusOnError="true">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvToDate" runat="server" ErrorMessage="*"
                                                    ControlToValidate="txtToDate" ForeColor="Red" Display="Dynamic" SetFocusOnError="true">
                                                </asp:RequiredFieldValidator>
                                        ...
                                        <div class="col-12 mobile-inputs">
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    ...
                                                    <asp:Repeater ID="rSReport" runat="server">
                                                        <HeaderTemplate>
