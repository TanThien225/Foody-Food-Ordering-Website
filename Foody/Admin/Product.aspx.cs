...
namespace Foody.Admin
{
    public partial class Product : System.Web.UI.Page
    {
        ...
        protected void rProduct_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                Label lblIsActice = e.Item.FindControl("lblIsActive") as Label;
                Label lblQuantity = e.Item.FindControl("lblQuantity") as Label;
                if (lblIsActice.Text == "True")
                {
                    lblIsActice.Text = "Active";
                    lblIsActice.CssClass = "badge badge-success";
                }
                else
                {
                    lblIsActice.Text = "In-Active";
                    lblIsActice.CssClass = "badge badge-danger";
                }

                // Anounce if that product quantity <=5
